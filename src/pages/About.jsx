...
해당 위치 주변의 인기 맛집을 추천. 사용자 리뷰와 평점을 반영하여 맞춤형 추천 제공
      ...
      >
        <h1>인사말</h1>
        <p>
        안녕하세요! 여행의 새로운 길을 열어주는 PHOTATO에 오신 것을 환영합니다.   <br></br>

PHOTATO는 여러분의 소중한 여행 사진을 통해 최고의 국내 여행지를 추천하는 혁신적인 서비스입니다. <br></br> 

여행지 선택이 고민되시나요? <br></br>
여러분이 업로드한 사진에서 GPS 정보를 분석하여 위치 정보를 제공하고, 주변의 유명한 관광지와 아름다운 자연 경관을 한눈에 확인할 수 있도록 도와드립니다.<br></br>

사진 속 풍경만큼이나 멋진 여행지를 찾고 계신가요?<br></br>
PHOTATO는 여러분의 사진을 통해 발견한 위치를 기반으로 주변의 숨겨진 명소와 인기 관광지를 추천합니다. 또한, 해당 위치 주변의 숙소를 추천해드리며, 객실의 이미지를 왜곡 없이 VR 또는 360º 동영상으로 제공하여 실제와 같은 경험을 선사합니다. 여행의 즐거움은 맛있는 음식과 함께 완성되죠. PHOTATO는 사용자 리뷰와 평점을 반영하여 해당 위치 주변의 인기 맛집도 맞춤형으로 추천해드립니다.
...
사진 한 장으로 시작되는 여행, 지금 바로 PHOTATO에서 시작하세요! <br></br>
