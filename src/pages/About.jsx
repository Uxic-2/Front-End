    ...
    <div>
      ...
      <section ref={greetingRef} data-section="인사말" className="greeting-section">
        <p>
          ...
          여행지 선택이 고민되시나요? <br></br>PHOTATO가 도와드리겠습니다. 
          여러분이 업로드한 사진에서 GPS 정보를 분석하여 위치 정보를 제공하고, 
          주변의 유명한 관광지와 아름다운 자연 경관을 한눈에 확인할 수 있도록 도와드립니다.<br></br><br></br><br></br>
          ...
          PHOTATO는 사용자 리뷰와 평점을 반영하여 해당 위치 주변의 인기 맛집도 맞춤형으로 추천해드립니다.<br></br><br></br><br></br>
          PHOTATO는 직관적인 UI/UX를 통해 사용자가 쉽게 사진을 업로드하고, 
          다양한 여행지 사진을 확인할 수 있도록 설계되었습니다. 
          또한, 사용자의 선호도를 반영한 개인 맞춤형 여행 추천 기능으로, 
          여러분의 여행 경험을 더욱 특별하게 만들어 드립니다.<br></br><br></br><br></br>
